                    ...
                    <div class="fileinput-new thumbnail">
                        <div class="options">
                            <ul>
                                ...
                                <li class="tooltips open-file" data-toggle="tooltip" title="{{trans('file_manager::app.components.tooltips.open')}}" data-file="{{url('uploads/original/'.$defaultFile)}}" data-placement="bottom">
